    ...
    <div className="min-h-screen bg-ink flex flex-col items-center justify-center px-6">
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div>
            <label className="mono text-[11px] tracking-[.12em] text-text-tertiary uppercase mb-1.5 block">Nome</label>
            <input
              type="text"
              value={name}
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3.5 mt-2 bg-emerald text-[#04130C] font-semibold text-sm rounded-xl hover:bg-emerald-glow transition-all disabled:opacity-60"
          >
        ...
        <p className="text-center text-sm text-text-secondary mt-8">
          Ja tem conta?{" "}
          <Link href="/login" className="text-emerald font-medium hover:text-emerald-glow transition-colors">
            Entrar
          </Link>
        </p>
      </div>
